...
<style>
    ...
    .tag {display:inline;float:left;padding:2px 5px;width:auto;background:#e48cff;color:#fff;height:23px;}
...
echo'                           <br><br><br>
                                <a id="buyLink" href="'.$target.'" class="btn btn-lg btn-danger" style="padding:15px;color:white;text-decoration:none;"> 
                                    ADD TO CART for '.$row["Price"] .' Leke<br>
                                    <span style="text-decoration:line-through;"> '.$row["MRP"].' Leke</span> 
